...
# ----- New Data
stat1 <- read.csv("Fertility_Data.csv")
...
stat2 <- data.frame(Code = Country_Code, Life_Expectancy_1960 = Life_Expectancy_At_Birth_1960, Life_Expectancy_2013 = Life_Expectancy_At_Birth_2013)    
...
# Split years
ft1960 <- stat1[stat1$Year == "1960", ]
ft2013 <- stat1[stat1$Year == "2013", ]

# Merge & create new data frame
df1960 <- merge(ft1960, stat2, by.x = "Country.Code", by.y = "Code")
df1960$Life_Expectancy_2013 <- NULL

df2013 <- merge(ft2013, stat2, by.x = "Country.Code", by.y = "Code")
df2013$Life_Expectancy_1960 <- NULL
